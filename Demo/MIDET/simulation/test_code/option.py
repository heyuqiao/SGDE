...
parser.add_argument('--data_root', type=str, default='D:/Dataset/HSI/Imaging/', help='dataset directory')

# Saving specifications
# parser.add_argument('--outf', type=str, default='/home/data/zd/MIDET/exp/ours/', help='saving_path')
parser.add_argument('--outf', type=str, default='./Quality_Metrics/result', help='saving_path')
...
parser.add_argument('--pretrained_model_path', type=str, default='../../checkpoints/simulation/midet_9stg.pth', help='pretrained model directory')
