...
# Data specifications
parser.add_argument('--data_root', type=str, default='/dataset/imaging/', help='dataset directory')
parser.add_argument('--data_path_CAVE', default='/dataset/imaging/CAVE_512_28/', type=str,
                        help='path of data')
parser.add_argument('--data_path_KAIST', default='/dataset/imaging/KAIST_CVPR2021/', type=str,
                    help='path of data')
parser.add_argument('--mask_path', default='/dataset/imaging/TSA_real_data/mask.mat', type=str,
                    help='path of mask')
