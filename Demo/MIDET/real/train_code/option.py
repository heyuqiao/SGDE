...
parser.add_argument('--data_path_CAVE', default='/home/data/zd/datasets/cave_1024_28_t/', type=str,
                        help='path of data')
parser.add_argument('--data_path_KAIST', default='/home/data/zd/datasets/KAIST_CVPR2021/', type=str,
                    help='path of data')
parser.add_argument('--mask_path', default='/home/data/zd/datasets/TSA_real_data/mask.mat', type=str,
                    help='path of mask')

# Saving specifications
parser.add_argument('--outf', type=str, default='./exp/midet_2/', help='saving_path')

# Model specifications
parser.add_argument('--method', type=str, default='midet_2', help='method name')
